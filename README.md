...
| `cubiboot_picoloader_payload.uf2` | PicoLoader firmware with cubiboot **embedded**, in one file — flash just this to the RP2040 Pico (nothing to flash before it); no loader file needed on the card. |
